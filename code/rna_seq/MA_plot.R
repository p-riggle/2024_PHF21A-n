...
resLFC <- read.csv("/Users/jacklynstaffeld/2024_PHF21A-n/data/processed/2024-03-13-deseq_CE16_CKO_WT.txt")
...
ma_plot <- ggplot() +
  ...
  scale_color_manual(values = c("UP" = "lightblue", "DOWN" = "pink", "NO" = "light grey"),
